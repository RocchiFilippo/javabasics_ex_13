...
public class Main {
    ...
    public static void exercise1() {
        ...
        System.out.println("number in 0 position = " + numbers.get(0));

        numbers.remove(0);
        numbers.remove(0);
        numbers.remove(0);

        System.out.println("now, the number in 0 position is = " + numbers.get(0));
    ...
    public static void exercise2() {
        ...
        System.out.println("I've order " + menuItems.get(myOrder) + ", it's cost = " + menuPrices.get(myOrder));
    }
    ...
    public static void exercise3() {
        ...
        System.out.println("the total sum of the values in the array is " + total);
    }
}
